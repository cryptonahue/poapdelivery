...
const ItemFooter = ({ href, children, ...props }) => {
  return (
    <Link href={`${href}`}>
      <a>
  ...
  return (
    <footer>
      <div className="Footer__container" id="Footer__container">
        {/* <div className="img_footer" id="img_footer">
          <ItemFooter href="/">
            <img src="/img/logo.svg" width="176px" height="40px" alt="Logo" />
          </ItemFooter>
        </div>
        <div className="Footer__item-about" id="footer__about">
          <ul>
          </ul>
        </div>
        <div className="titulo-community" id="titulo__community">
          <h3>Síguenos</h3>
        </div>
        <div className="Footer__item-community" id="footer__community">
          <ul>
            <li>
              <Button
                className="BotonesFooter"
                color="inherit"
                component="a"
        ...
        <div className="titulo-siguenos" id="titulo-siguenos">
          <h3>Comunidad</h3>
        </div>
        <div className="Footer__item-follow" id="footer__follow">
          <ul>
            <li>
              <Button
                color="inherit"
